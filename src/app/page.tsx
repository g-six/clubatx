...
export default function LoginPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  return (
    <Suspense fallback={<>...</>}>
      <div className="relative h-screen w-screen overflow-x-hidden bg-white pt-8 pb-24 sm:py-32 dark:bg-gray-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div className="aspect-video w-3xl max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 max-sm:hidden sm:w-228 md:-ml-4 lg:-ml-0 dark:ring-white/10">
      ...
      <div
        role="button"
        className="fixed w-full max-sm:bottom-6 max-sm:left-1/2 max-sm:max-w-sm max-sm:-translate-x-1/2 sm:top-0 sm:right-0"
      >
