  ...
  return (
    <span
      ...
      className={clsx([
        ...
        className?.split(' ').includes('rounded-l')
          ? 'before:rounded-l-[calc(var(--radius-lg)-1px)] after:rounded-l-lg'
          : className?.split(' ').includes('rounded-r')
            ? 'before:rounded-r-[calc(var(--radius-lg)-1px)] after:rounded-r-lg'
            : 'before:rounded-[calc(var(--radius-lg)-1px)] after:rounded-lg',
      ])}
    >
      <Headless.Input
        ref={ref}
        ...
        className={clsx([
          ...
          'dark:scheme-dark',
          inputClassName,
          inputClassName?.includes('border') ? null : 'border',
          inputClassName?.includes('rounded') ? null : 'rounded-lg',
        ])}
      />
    </span>
  )
